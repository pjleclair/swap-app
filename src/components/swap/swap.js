    ...
    return(
        <div className="swap--container">
            ...
            <div className="convert--container">
                ...
                <div className="swap--convert-container">
                    <div className="swap--convert">
                        <div className="swapFrom--container">
                            <div id="val">1.20004</div>
                            <div id="coin"><img src={btcLogo} alt="btc"/>BTC</div>
                        </div>
                        ...
                        <div className="swapTo--container">
                            <div id="val">1,200,420.69</div>
                            <div id="coin"><img src={usdtLogo} alt="usdt"/>USDT</div>
                        </div>
                        <div className="tx--container">
                            <div id="fee">Transaction fee: 0.20$</div>
                            <button id="swap">Exchange</button>
                        </div>
                    </div>
                </div>
            </div>
